...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      let e4 = "undefined" != typeof globalThis && globalThis.AsyncLocalStorage, e6 = e4 ? new e4() : new e3();
      class e5 {
        ...
        addCallback(e10) {
          ...
          let i2 = e6.getStore(), s2 = i2 ? i2.rootTaskSpawnPhase : null == r10 ? void 0 : r10.phase;
          this.runCallbacksOnClosePromise || (this.runCallbacksOnClosePromise = this.runCallbacksOnClose(), this.waitUntil(this.runCallbacksOnClosePromise));
          let n2 = (t10 = async () => {
            try {
              await e6.run({ rootTaskSpawnPhase: s2 }, () => e10());
            } catch (e11) {
              this.reportTaskError("function", e11);
            }
          }, e4 ? e4.bind(t10) : e3.bind(t10));
    ...
    if (e.data.event === "start") {
      ...
      let t3 = (e10) => {
        ...
        if (Array.isArray(e10))
          return e10.map((e11) => t6(e11));
        if ("function" == typeof e10 || e10 !== Object(e10))
          return e10;
        let t10 = {};
        return Object.entries(e10).forEach(([e11, r10]) => {
          t10[e11.replace(/([-_][a-z])/gi, (e12) => e12.toUpperCase().replace(/[-_]/g, ""))] = t6(r10);
        }), t10;
      };
      ...
      let t9 = (e10) => e10.msg || e10.message || e10.error_description || e10.error || JSON.stringify(e10), t8 = (e10, t10, r10) => t5(void 0, void 0, void 0, function* () {
        e10 instanceof (yield t4()) && !(null == r10 ? void 0 : r10.noResolveJson) ? e10.json().then((r11) => {
      ...
      async function r9(e10, t10, r10, i2, s2, n2) {
        let a2;
        let o2 = r6(t10, i2, s2, n2);
        try {
          a2 = await e10(r10, Object.assign({}, o2));
        } catch (e11) {
          throw console.error(e11), new rQ(r2(e11), 0);
        }
        if (a2.ok || await r4(a2), null == i2 ? void 0 : i2.noResolveJson)
          return a2;
        try {
...
https://supabase.com/dashboard/project/_/settings/api`);
            let { storage: i3, getAll: s2, setAll: n2, setItems: a2, removedItems: o2 } = function(e12, t12) {
              let r12, i4;
              let s3 = e12.cookies ?? null, n3 = e12.cookieEncoding, a3 = {}, o3 = {};
              if (s3) {
                if ("get" in s3) {
                  let e13 = async (e14) => {
                    let t13 = e14.flatMap((e15) => [e15, ...Array.from({ length: 5 }).map((t14, r14) => `${e15}.${r14}`)]), r13 = [];
                    for (let e15 = 0; e15 < t13.length; e15 += 1) {
                      let i5 = await s3.get(t13[e15]);
                      (i5 || "string" == typeof i5) && r13.push({ name: t13[e15], value: i5 });
                    }
                    return r13;
                  };
                  if (r12 = async (t13) => await e13(t13), "set" in s3 && "remove" in s3)
                    i4 = async (e14) => {
                      for (let t13 = 0; t13 < e14.length; t13 += 1) {
                        let { name: r13, value: i5, options: n4 } = e14[t13];
                        i5 ? await s3.set(r13, i5, n4) : await s3.remove(r13, n4);
                      }
                    };
                  else if (t12)
                    i4 = async () => {
                ...
                } else if ("getAll" in s3) {
                  if (r12 = async () => await s3.getAll(), "setAll" in s3)
                    i4 = s3.setAll;
                  else if (t12)
                    i4 = async () => {
              ...
              return t12 ? { getAll: r12, setAll: i4, setItems: a3, removedItems: o3, storage: { isServer: true, getItem: async (e13) => {
                ...
                if (!i5)
                  return null;
                let s4 = i5;
                return "string" == typeof i5 && i5.startsWith(tb) && (s4 = tm(i5.substring(tb.length))), s4;
              }, setItem: async (t13, s4) => {
                t13.endsWith("-code-verifier") && await tw({ getAll: r12, setAll: i4, setItems: { [t13]: s4 }, removedItems: {} }, { cookieOptions: e12?.cookieOptions ?? null, cookieEncoding: n3 }), a3[t13] = s4, delete o3[t13];
                ...
                if (!i5)
                  return null;
                let s4 = i5;
                return i5.startsWith(tb) && (s4 = tm(i5.substring(tb.length))), s4;
              }, setItem: async (t13, s4) => {
                let a4 = await r12([t13]), o4 = new Set((a4?.map(({ name: e13 }) => e13) || []).filter((e13) => tc(e13, t13))), l3 = s4;
                "base64url" === n3 && (l3 = tb + tv(s4));
                let u2 = th(t13, l3);
                u2.forEach(({ name: e13 }) => {
                  o4.delete(e13);
                });
                ...
                let s4 = await r12([t13]), n4 = (s4?.map(({ name: e13 }) => e13) || []).filter((e13) => tc(e13, t13)), a4 = { ...tl, ...e12?.cookieOptions, maxAge: 0 };
                delete a4.name, n4.length > 0 && await i4(n4.map((e13) => ({ name: e13, value: "", options: a4 })));
              } } };
            ...
            return l2.auth.onAuthStateChange(async (e12) => {
              (Object.keys(a2).length > 0 || Object.keys(o2).length > 0) && ("SIGNED_IN" === e12 || "TOKEN_REFRESHED" === e12 || "USER_UPDATED" === e12 || "PASSWORD_RECOVERY" === e12 || "SIGNED_OUT" === e12 || "MFA_CHALLENGE_VERIFIED" === e12) && await tw({ getAll: s2, setAll: n2, setItems: a2, removedItems: o2 }, { cookieOptions: r11?.cookieOptions ?? null, cookieEncoding: r11?.cookieEncoding ?? "base64url" });
            }), l2;
          }("https://xfholgmbmwejohgtzuih.supabase.co", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InhmaG9sZ21ibXdlam9oZ3R6dWloIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MzgyNTUwNTcsImV4cCI6MjA1MzgzMTA1N30.tzgMvhhcCLtE_tRfQmk-5BvzF8GBez-P7ebcAY3LKKU", { cookies: { getAll: () => e10.cookies.getAll(), setAll(r11) {
            r11.forEach(({ name: t11, value: r12 }) => e10.cookies.set(t11, r12)), t10 = Q.next({ request: e10 }), r11.forEach(({ name: e11, value: r12, options: i3 }) => t10.cookies.set(e11, r12, i3));
          } } }), i2 = await r10.auth.getUser();
          if (e10.nextUrl.pathname.startsWith("/protected") && i2.error)
            return Q.redirect(new URL("/sign-in", e10.url));
          if ("/" === e10.nextUrl.pathname && !i2.error)
            return Q.redirect(new URL("/protected", e10.url));
          return t10;
        } catch (t10) {
          return Q.next({ request: { headers: e10.headers } });
        }
      };
